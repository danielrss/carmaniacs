...
namespace CarManiacs.Business.Models.UnitTests.Projects
{
    ...
    public class ProjectComment
    {
        ...
        public void PublishDate_ShouldBeSetAndGottenCorrectly()
        {
            ...
            //Act
            var projectComment = new Models.Projects.ProjectComment() { PublishDate = testDate };

            //Assert
            Assert.AreEqual(testDate, projectComment.PublishDate);
        }
        ...
        public void IsDeleted_ShouldBeSetAndGottenCorrectly()
        {
            ...
            //Act
            var projectComment = new Models.Projects.ProjectComment { IsDeleted = isDeleted };

            //Assert
            Assert.AreEqual(isDeleted, projectComment.IsDeleted);
        }
